 ...
 * If successful, the list of custom model providers in the Aggrag UI dropdown is updated.
 * */
          ...
          read_file(files[0], (content: string | ArrayBuffer | null) => {
            ...
            initCustomProvider(content)
              .then((providers) => {
                ...
                // now load them into the Aggrag UI:
          ...
          <Tabs defaultValue="api-keys">
            ...
            <Tabs.Panel value="ai-support" pt="xs">
              <Text mb="md" fz="sm" lh={1.3}>
                AI support features in Aggrag include purple sparkly buttons{" "}
            ...
            {APP_IS_RUNNING_LOCALLY() ? (
              <Tabs.Panel value="custom-providers" pt="md">
                <Text mb="md" fz="sm" lh={1.3}>
                  You can add model providers to Aggrag by writing custom
            ...
            <Tabs.Panel value="advanced" pt="xs">
              <Box p="md">
                <Checkbox
                  ...
                  Aggrag automatically compresses images output from LLMs."

...
const CodeEvaluatorNode: React.FC<CodeEvaluatorNodeProps> = ({
  ...
  // When Aggrag is running nonlocally (i.e. the website) Python code is always run sandboxed.
  ...
  useEffect(() => {
    if (!IS_RUNNING_LOCALLY && progLang === "python") {
      ...
      console.warn(
        `This flow contains a Python evaluator node, yet Aggrag does not appear to be running locally on your machine. 

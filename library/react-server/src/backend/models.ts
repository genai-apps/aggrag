/**
 * A list of all model APIs natively supported by Aggrag.
 */
...
/**
 * Given an RAG, return what the model provider is.
 * @param rag the specific large language model
 * @returns an `RAGProvider` describing what provider hosts the model
 */
